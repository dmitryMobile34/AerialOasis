...
import com.appxplore.clawstar.Constants.Campaign2
import com.appxplore.clawstar.Constants.Campaign3
...
class WebView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view1 = findViewById(R.id.AOView)
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.appxplore.clawstar"
